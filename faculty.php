...
<section class="mentor-zone" style="background: #fff;">
  <div class="mentor-wrap">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <h2 class="title text-center">Industry Mentorship at<span> INSD</span></h2>
    ...
    <!-- Owl Carousel -->
    <div class=" e1 owl-carousel mt-4">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        ...
        <h2 class="title  text-center">Faculty <span> Members</span></h2>
