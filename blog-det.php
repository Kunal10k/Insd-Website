  ...
  <div class="container blog-details-container">
    ...
    <div class="blog-details-content">
      ...
      <div class="blog-details-img">
        <img src="https://picsum.photos/1200/600?random=20" alt="Blog">
      </div>

      <!-- Meta -->
      <div class="blog-details-meta">
        <span><i class="fa-solid fa-calendar"></i> 18 Nov 2025</span>
        <span><i class="fa-solid fa-clock"></i> 10:30 AM</span>
        <span><i class="fa-solid fa-user"></i> Admin</span>
      </div>

      <!-- Blog Title -->
      <h1 class="blog-details-title">
        How to Choose the Right Career After 12th – Complete Guide
      </h1>

      <!-- Blog Content -->
      <div class="blog-details-text">
        <p>
          Choosing a career after 12th is one of the biggest decisions students face.
          With countless options available, selecting the right path may feel overwhelming.
        </p>

        <h2>1. Understand Your Interests</h2>
        <p>
          Before choosing any career, the most important thing is to know what you truly love
          and enjoy doing. Your passion plays a major role in long-term success.
        </p>

        <h2>2. Explore Available Courses</h2>
        <p>
          Research the best courses available for your field of interest. Check the syllabus,
          job prospects, duration, and future career scope.
        </p>

        <blockquote>
          “Success starts with choosing the right direction and staying committed to it.”
        </blockquote>

        <h2>3. Speak with Experts</h2>
        <p>
          Talk to teachers, counsellors, and professionals who can guide you with real industry experience.
        </p>

        <p>
          Making the right decision will shape your future — choose wisely and confidently.
        </p>
      </div>
    ...
    <aside class="blog-sidebar">
      ...
      <div class="sidebar-box">
        <h3>Recent Posts</h3>
        <ul>
          <li><a href="#">Best Career Options in Fashion Industry</a></li>
          <li><a href="#">5 Tips to Improve Your Design Skills</a></li>
          <li><a href="#">Why Graphic Design is Trending in 2025</a></li>
        </ul>
      </div>
