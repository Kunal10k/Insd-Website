...
<!-- <section class="collaboration">
    ...
    <div class="collab-cards">
        <div class="collab-card">
            ...
            <p>Join our ongoing research projects with industry leaders to innovate and develop new technologies.</p>
        </div>
        <div class="collab-card">
            <h3>Internship Programs</h3>
            <p>Offer or apply for internships to build skills and gain hands-on experience in industry environments.</p>

        </div>
        <div class="collab-card">
            <h3>Workshops & Seminars</h3>
            <p>Participate in workshops and seminars designed to share knowledge and enhance professional skills.</p>

        </div>
        <div class="collab-card">
            <h3>Industry Labs</h3>
            <p>Collaborate in industry-funded labs to research, prototype, and innovate cutting-edge solutions.</p>
...
<section class="success">
    <div class="container">
        ...
        <div class="owl-carousel success-cards">
            <div class="success-card">
                <img src="assets/img/3 (2).jpg" alt="Project 1">
                <div class="content">
                    <h3>Project Alpha</h3>
                    <p>Collaboration with XYZ Corp led to innovative product development and industry recognition.</p>
                </div>
            </div>
            <div class="success-card">
                <img src="assets/img/3 (2).jpg" alt="Project 2">
                <div class="content">
                    <h3>Project Beta</h3>
                    <p>Joint research initiatives resulted in breakthrough solutions in sustainable energy.</p>
                </div>
            </div>
            <div class="success-card">
                <img src="assets/img/3 (2).jpg" alt="Project 3">
                <div class="content">
                    <h3>Project Gamma</h3>
                    <p>Partnership with leading tech companies enhanced student learning and innovation.</p>
                </div>
            </div>
        </div>
    </div>
