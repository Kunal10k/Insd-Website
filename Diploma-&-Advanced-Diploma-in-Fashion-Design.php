            ...
            <div class="col-md-12">
                <div class="banner-top  ">
                    <div class="banner-badge-top  ">
                        ...
                        <span class="subtitle">Diploma & Advanced Diploma</span>
                    </div>

                    <div class="banner-badge-top m-0">
                        <i class="fa-solid fa-building-columns"></i>
                        <span class="subtitle">1+2 Years | Full-Time (On-Campus)</span>
                    </div>
                ...
                <!-- <h6>Diploma & Advanced Diploma in Fashion Design & Technology
                </h6> -->
                <h1 class="title">Diploma & Advanced Diploma <br class="d-none d-md-block"> in Fashion <span>Design & Technology</span></h1>
                <p class="para ">

                    Practical fashion design programs focused on skill development,<br class="d-none d-md-block"> industry exposure, and career readiness.
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Fashion Design Program – Curriculum Snapshot & Learning Experience
                                        </button>
                                    </h2>
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more" id="details">
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <ul class="rbt-list-style-1">
                                <li><i class="fa-solid fa-circle-check me-2"></i>Fashion Designer (Entry-Level)</li>
                                <li><i class="fa-solid fa-circle-check me-2"></i>Assistant Fashion Designer</li>
                                ...
                                <li><i class="fa-solid fa-circle-check me-2"></i>Boutique / Studio Assistant</li>
                            </ul>
                            ...
                            <ul class="rbt-list-style-1">
                                ...
                                <li><i class="fa-solid fa-circle-check me-2"></i>Exposure to fashion studios, brands, export houses, and retail organisations</li>
                            </ul>
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more" id="Eligibility">
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <ul class="rbt-list-style-1">
                                ...
                                <li><i class="fa-solid fa-circle-check me-2"></i>No prior fashion or design background required</li>
                                <li><i class="fa-solid fa-circle-check me-2"></i>Creative interest in fashion, styling, and garment execution encouraged</li>
                            </ul>
                            ...
                            <p>
                                INSD Kolkata offers scholarship support to eligible students to encourage creative potential and make
                                professional fashion education more accessible. Scholarship eligibility and details are explained clearly
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                ...
                <ul class="list-unstyled mt-4">
                    <li class="mb-3 d-flex">
                        ...
                        Students interested in starting a career in fashion design
                    </li>
                    <li class="mb-3 d-flex">
                        <span class="me-2">✔</span>
                        Students interested in starting a career in fashion design
                    ...
                    <li class="mb-3 d-flex">
                        <span class="me-2">✔</span>
                        Learners who prefer shorter, skill-focused programs
                    </li>
                    <li class="mb-3 d-flex">
                        <span class="me-2">✔</span>
                        Students planning to enter the fashion industry quickly
                    </li>
                    <li class="mb-3 d-flex">
                        <span class="me-2">✔</span>
                        Aspiring designers seeking strong execution and studio exposure
                    </li>
                </ul>
            ...
            <div class="col-lg-4 text-center">
                <img src="assets/img/p1.png" alt="B.Des Interior Design INSD Kolkata" class="img-fluid rounded shadow">
            </div>
...
<section class="career-cta">
    <div class="container text-center">
        ...
        <h3 class="cta-title">
            Start Your Fashion Design Career with INSD
        </h3>
        ...
        <div class="instructor-wrapper shadow-sm p-4 rounded">
            ...
            <div class="instructor-carousel owl-carousel owl-loaded owl-drag">
                ...
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(-2720px, 0px, 0px); transition: 0.7s; width: 4352px;">
