...
<section class="blog-section">
  <div class="container">
    <h5 class="sub-head text-center cen">Blog</h5>
    <h2 class="title text-center">Latest <span>Blog Posts</span></h2>
    ...
    <div class="blog-grid">
      ...
      <div class="blog-card">
        <div class="blog-img">
          <img src="https://picsum.photos/600/400?random=1" alt="blog">
        </div>
        <div class="blog-content">
          <span class="blog-category">Education</span>

          <div class="blog-meta">
            <span class="blog-date"><i class="fa-solid fa-calendar"></i> 18 Nov 2025</span>
            <span class="blog-time"><i class="fa-solid fa-clock"></i> 10:30 AM</span>
          </div>

          <h3 class="blog-title">How to Choose the Right Career After 12th</h3>
          <p class="blog-text">Discover key factors to consider when selecting your ideal career path.</p>
          <a href="blog-det.php" class="blog-btn">Read More →</a>
        </div>
      ...
      <div class="blog-card">
        <div class="blog-img">
          <img src="https://picsum.photos/600/400?random=2" alt="blog">
        </div>
        <div class="blog-content">
          <span class="blog-category">Education</span>
          ...
          <h3 class="blog-title">Top 10 Web Design Trends in 2025</h3>
          <p class="blog-text">Stay updated with the latest and most modern web design ideas.</p>
      ...
      <div class="blog-card">
        <div class="blog-img">
          <img src="https://picsum.photos/600/400?random=3" alt="blog">
        </div>
        <div class="blog-content">
          <span class="blog-category">Education</span>
          ...
          <h3 class="blog-title">5 Powerful Study Habits for Students</h3>
          <p class="blog-text">Improve your learning ability with these proven techniques.</p>
          <a href="#" class="blog-btn">Read More →</a>
        </div>
      </div>
