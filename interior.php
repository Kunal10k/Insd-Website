...
<section class="ban">
  ...
  <div class="item">
    <div class="ban-sec">
      ...
      <div class="bg-zoom" style="background-image: url('./assets/img/sliderbg4.jpg');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
              ...
              <h1 class="title-ban">
                ...
                <span class="cd-headline slide">
                  <span id="words-wrapper" class="cd-words-wrapper">
                    <b class="theme-gradient is-visible">Interior Designing</b>
                    <b class="theme-gradient is-hidden">Interior Designing</b>
                    <b class="theme-gradient is-hidden">Interior Designing</b>
                  </span>
                </span>
              </h1>
          ...
          <div class="col-md-6">
            <img src="assets/img/interio-removebg-preview.png" alt="" class="ban-img">
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-12">
        <div class="sticky-menu">
          ...
          <!-- <ul class="service-menu">
            <li><a href="#s1">Skin Analysis & Care Regime</a> <i class="fa-solid fa-arrow-right"></i></li>
            <li><a href="#s2">Chemical Peels</a> <i class="fa-solid fa-arrow-right"></i></li>
            <li><a href="#s3">Peels</a> <i class="fa-solid fa-arrow-right"></i></li>
            <li><a href="#s4">Microneedling</a> <i class="fa-solid fa-arrow-right"></i></li>
            <li><a href="#s5">Vampire Facial</a> <i class="fa-solid fa-arrow-right"></i></li>
            <li><a href="#s6">Botox</a> <i class="fa-solid fa-arrow-right"></i></li>
          </ul> -->
        ...
        <div class="course-details-content">
          ...
          <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more" id="overview">
            <div class="rbt-course-feature-inner has-show-more-inner-content">
              ...
              <p class="para pb-4">Are you new to PHP or need a refresher? Then this course will help you get
          ...
          <div class="rbt-course-feature-box rbt-shadow-box details-wrapper mt--30" id="details">
            <div class="row g-5">
              ...
              <div class="col-lg-6">
                ...
                <ul class="rbt-list-style-1">
                  <li><i class="fa-solid fa-circle-check me-2"></i>Become an advanced, confident, and modern
                    JavaScript developer from scratch.</li>
                  <li><i class="fa-solid fa-circle-check me-2"></i>Have an intermediate skill level of Python
                    programming.</li>
                  <li><i class="fa-solid fa-circle-check me-2"></i>Have a portfolio of various data analysis
                    projects.</li>
                  <li><i class="fa-solid fa-circle-check me-2"></i>Use the numpy library to create and manipulate
                    arrays.</li>
                </ul>
              </div>
              <!-- End Feature Box -->
              ...
              <div class="col-lg-6">
                ...
                <ul class="rbt-list-style-1">
                  <li><i class="fa-solid fa-circle-check me-2"></i>Use the Jupyter Notebook Environment.
                    JavaScript developer from scratch.</li>
                  <li><i class="fa-solid fa-circle-check me-2"></i>Use the pandas module with Python to create and
                    structure data.</li>
                  <li><i class="fa-solid fa-circle-check me-2"></i>Have a portfolio of various data analysis
                    projects.</li>
                  <li><i class="fa-solid fa-circle-check me-2"></i>Create data visualizations using matplotlib and
                    seaborn.</li>
                </ul>
              </div>
              <!-- End Feature Box -->
              ...
              <div class="recruiter-section">
                ...
                <div class="recruiter-carousel owl-carousel">
                  <div class="recruiter-item">
                    <img src="assets/img/fashion/Aditya_Birla_Group_Logo.svg-300x184.png" alt="Recruiter Logo">
                  </div>
                  <div class="recruiter-item">
                    <img src="assets/img/fashion/gap-logo-png_seeklogo-59170-300x300.png" alt="Recruiter Logo">
                  </div>
                  <div class="recruiter-item">
...
<script>
  document.querySelectorAll('.service-menu li a').forEach(anchor => {
    anchor.addEventListener('click', function(e) {
      ...
      const offset = 200; // STOP AT 200PX BEFORE SECTION
      ...
      // Active class update
      document.querySelectorAll(".service-menu li").forEach(li => li.classList.remove("active"));
