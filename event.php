...
<section class="gallery-section" id="gallery">
  <div class="container">
    ...
    <h5 class="sub-head text-center cen">Event</h5>
    <h2 class="title text-center">Moments That Define   <br> <span>Our Journey</span></h2>
      
    <p class="para text-center pb-4">Every achievement, collaboration, and innovation at Emsurg tells a story of dedication and progress. Explore our gallery to relive the milestones, events, and inspiring moments that continue to shape our vision for better healthcare. </p>

    <!-- Filter Buttons -->
    <ul class="nav nav-pills justify-content-center custom-gallery-tab mb-4" id="pills-tab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-domestic-tab" data-bs-toggle="pill" data-bs-target="#pills-domestic" type="button" role="tab" aria-controls="pills-domestic" aria-selected="false">
          International
        </button>
      </li>
    </ul>
    ...
    <div class="tab-content" id="pills-tabContent">
      ...
      <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
        ...
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 1"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 2"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 3"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 4"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 5"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 6"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 7"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 8"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 9"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 10"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 11"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="Domestic"><img src="assets/img/1 (2).jpg" alt="Domestic 12"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="International"><img src="assets/img/1 (2).jpg" alt="International 1"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="International"><img src="assets/img/1 (2).jpg" alt="International 2"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="International"><img src="assets/img/1 (2).jpg" alt="International 3"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="International"><img src="assets/img/1 (2).jpg" alt="International 4"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="International"><img src="assets/img/1 (2).jpg" alt="International 5"></a>
        <a href="assets/img/1 (2).jpg" class="gallery-item glightbox" data-category="International"><img src="assets/img/1 (2).jpg" alt="International 6"></a>
