...
<!-- End Google Tag Manager (noscript) -->
    ...
    <!--  <ul class="icn-bx-ul">-->
    <!--    <a href="https://wa.me/916291065177" target="_blank">-->
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="Department-Overview-Design-interior-design.php">Department Overview
                              Design</a></li>
            ...
            <div class="row">
                <div class="col-md-7 col-sm-12 mt-5">
                    ...
                    <div class="landing_content mobile_work">
                        ...
                        <!--    <p class="para">
                            Career-focused interior design education with on-the-job training, live projects, and
                            placement support.
...
<section class="py-2  d-md-none d-block">
    <div class="container">
...
<section class="alumni-container p-0">
    <div class="row">
        <div class="col-md-3 content ny ">
            ...
            <h6 class="title ">industry <br class="d-md-block d-none">alliance</h6>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-12 order-2 order-lg-1">
                    ...
                    <ul class="nav nav-tabs tab-button-list mt-5" id="autoTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-button" data-bs-toggle="tab" href="#content2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-button" data-bs-toggle="tab" href="#content3">

                                Workshops, Site Visits & Exhibitions
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link tab-button" data-bs-toggle="tab" href="#content4">

                                Live Projects & On-the-Job Training
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link tab-button" data-bs-toggle="tab" href="#content5">

                                Continuous Feedback from Professionals
                            </a>
                        </li>
                ...
                <div class="col-lg-8 col-md-12 order-1 order-lg-2">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="content2"><img src="assets/img/new-photo/02- (1).jpeg"
                                alt="Header Layout"></div>
                        <div class="tab-pane fade" id="content3"><img src="assets/img/new-photo/02- (2).jpeg"
                                alt="Toolkit"></div>
                        <div class="tab-pane fade" id="content4"><img src="assets/img/new-photo/04.jpeg" alt="Flexible">
                        </div>
                        <div class="tab-pane fade" id="content5"><img src="assets/img/new-photo/04.jpeg" alt="Flexible">
                        </div>
                    </div>
                </div>
            </div>
...
<!--                <img src="assets/img/cropped-logo-1-1-2.png" alt="INSD Kolkata Logo" class="footer-logo text-center">-->
                <!--<p>-->
