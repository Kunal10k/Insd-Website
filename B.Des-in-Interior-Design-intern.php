...
<section class="inner_my_banner"
    style="background-image: url('./assets/img/courses/B.Des\ in\ Interior\ Design.webp');">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h6>B.Des in Interior Design
                </h6>
                <h1 class="title">B.Des in <br class="d-md-block d-none"><span> Interior Design</span></h1>
