...
<section class="landing_banner" id="form">
    <div class="banner lando" style="background-image: url('./assets/img/gp1.jpeg');">
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12 landing_pick">
                    <div class="landing_content  mobile_work">
                        ...
                        <h1 class="w-100 w-md-75">Start Your Graphic Design Career and get hired
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-content">
                        <h2><span class="stats-count" data-num="300">300</span>+</h2>
                        <p>Brand Associates</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-content">
                        <h2><span class="stats-count" data-num="11">11</span> L</h2>
                        <p>Highest Package</p>
                    </div>
                </div>
            </div>
...
<section class="histudy-courses ">
    <div class="container text-center">
        <h2 class="title text-center mb-4">Programs Offered in <br>
            <span class="histudy-highlight">Graphic Design & Technology</span>
        </h2>
        ...
        <div class="row g-4 mt-2 mt-md-2">
            ...
            <div class="col-md-4">
                <div class="course-card">
                    <div class="card-header">
                        <h2>Bachelor of Design in Graphic Design (B.Des)</h2>
                    </div>
            ...
            <!-- MBA in Graphic Design & Technology -->
            <div class="col-md-4">
                <div class="course-card">
                    <div class="card-header">
            ...
            <!-- Diploma / Advanced Diploma in Graphic Design -->
            <div class="col-md-4">
                <div class="course-card">
                    <div class="card-header">
        ...
        <div class="row g-4 mt-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="role-card">
                    ...
                    <h5>Motion Graphics Designer</h5>
                </div>
            </div>
