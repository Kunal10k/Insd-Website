    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="title">Bachelor of Design <br class="d-none d-md-block">in Fashion <span>Design & Technology</span> </h1>
                    ...
                    <div class="col-md-10">
                        <div class="course-highlights">
                            ...
                            <div class="highlight-card">
                                ...
                                <div class="highlight-text">10+2 Pass (Any Stream)</div>
                            </div>
                ...
                <div class="course-details-content">
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more" id="overview">
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <p class="para pb-4">
                                The Bachelor of Design (B.Des) in Fashion Design & Technology is a professional undergraduate degree program designed to develop creative, technically skilled, and industry-ready fashion designers.
                                The program combines fashion design, garment construction, textiles, fashion technology, business fundamentals, and professional practice, ensuring students gain both creative depth and execution capability.
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            Fashion Design Program Curriculum Overview
                                        </button>
                                    </h2>
                        ...
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <div class="eligibility-section">
                                ...
                                <ul class="rbt-list-style-1">
                                    ...
                                    <li><i class="fa-solid fa-circle-check me-2"></i>Creativity, interest in fashion, and willingness to learn encouraged</li>
                                </ul>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-lg-7 mb-4 mb-lg-0">
                <h2 class="mb-3 title">
                    Why Study B.Des in Fashion <span>Design & Technology at INSD</span>
                </h2>
                ...
                <div class="benifit-wraps">
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Industry-aligned curriculum focused on real fashion careers</h5>
                        </div>
                    </div>
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Studio-based practical learning with strong garment construction exposure</h5>
                        </div>
                    </div>
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Masterclasses by practicing fashion designers and industry professionals in every semester</h5>
                        </div>
                    </div>
                    <div class="benefit-item">
                        <div class="icon-circle">
                        ...
                        <div class="benefit-text">
                            <h5>Exposure to fashion shows, exhibitions, and design presentations</h5>
                        </div>
                    </div>
                    <div class="benefit-item">
                        <div class="icon-circle">
            ...
            <div class="col-lg-5 text-center">
                ...
                <div class="image_changer" style="height: 650px;">

                    <img src="assets/img/fashion/02- (1).jpg" class="active">
                    <img src="assets/img/fashion/02- (1).png">
                    <img src="assets/img/fashion/02- (2).jpg">
                    <img src="assets/img/fashion/02- (2).png">
