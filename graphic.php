...
<section class="ban">
  ...
  <div class="item">
    <div class="ban-sec">
      ...
      <div class="bg-zoom" style="background-image: url('./assets/img/sliderbg3.jpg');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
              ...
              <h1 class="title-ban">
                ...
                <span class="cd-headline slide">
                  <span id="words-wrapper" class="cd-words-wrapper">
                    <b class="theme-gradient is-visible">Graphic Designing</b>
                    <b class="theme-gradient is-hidden">Graphic Designing</b>
                    <b class="theme-gradient is-hidden">Graphic Designing</b>
                  </span>
                </span>
              </h1>
          ...
          <div class="col-md-6">
            <img src="assets/img/graphi-removebg-preview.png" alt="" class="ban-img">
          </div>
        </div>
