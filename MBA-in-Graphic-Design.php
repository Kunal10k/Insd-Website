...
<section class="inner_Section"
    style="background-image: url('./assets/img/inner_banner/B.Des\ in\ Graphic\ Design\ \(1\).jpg');">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="title">MBA in Graphic Design <span>
                        <br> & Technology</span> </h1>
                ...
                <div class="course-details-content">
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more"
                        ...
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <p class="para pb-4">
                                The MBA in Graphic Design & Technology at INSD Kolkata is a postgraduate program designed for creative professionals who want to combine design expertise with business and technology skills.
                                The program focuses on digital design, UI/UX, multimedia production, and creative business management.
                                Students gain exposure to industry tools, live projects, and strategic design thinking to prepare for leadership roles in the creative industry.
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more"
                        ...
                        <div class="rbt-accordion-style rbt-accordion-02 accordion">
                            ...
                            <div class="accordion mt-3" id="accordionSemester">

                                <!-- SEM 1 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="sem1">
                                    ...
                                    <div id="collapseSem1" class="accordion-collapse collapse show" data-bs-parent="#accordionSemester">
                                        <div class="accordion-body">

                                            <ul class="campus-features mt-3">

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Fundamentals of Drawing & Design</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Design Principles & Visual Communication</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>CorelDRAW for Graphic Design</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Adobe Photoshop – Image Editing & Manipulation</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Adobe Illustrator – Vector Graphics & Illustration</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Financial Management for Creative Professionals</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Creative Thinking & Concept Development</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Live Projects / Practical Training</strong>
                                                </li>
                                ...
                                <!-- SEM 2 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="sem2">
                                    ...
                                    <div id="collapseSem2" class="accordion-collapse collapse" data-bs-parent="#accordionSemester">
                                        <div class="accordion-body">
                                            ...
                                            <ul class="campus-features mt-3">
                                                ...
                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Adobe XD for Interface Design</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Digital Marketing & Brand Communication</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Sales Strategies for Creative Businesses</strong>
                                                </li>
                                                ...
                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Adobe Dreamweaver – Web Design Tools</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>CSS 3.0 & HTML 5 – Web Development</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Design Business & Client Management</strong>
                                                </li>
                                ...
                                <!-- SEM 3 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="sem3">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSem3">
                                            <i class="fa-solid fa-layer-group me-2"></i>
                                            SEM – 3
                                        </button>
                                    </h2>

                                    <div id="collapseSem3" class="accordion-collapse collapse" data-bs-parent="#accordionSemester">
                                        <div class="accordion-body">

                                            <ul class="campus-features mt-3">

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>JavaScript – Interactive Web Development</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>PHP Programming for Web Applications</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Fluid Layout & Responsive Web Design</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Adobe Premiere Pro – Video Editing</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Adobe After Effects – Motion Graphics</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Operations Management for Creative Agencies</strong>
                                                </li>
                                                ...
                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Creative Project Management</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Portfolio Development Workshops</strong>
                                                </li>
                                ...
                                <!-- SEM 4 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="sem4">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSem4">
                                            <i class="fa-solid fa-layer-group me-2"></i>
                                            SEM – 4
                                        </button>
                                    </h2>

                                    <div id="collapseSem4" class="accordion-collapse collapse" data-bs-parent="#accordionSemester">
                                        <div class="accordion-body">

                                            <ul class="campus-features mt-3">

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Marketing Research for Creative Industries</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Web Hosting & Digital Platform Deployment</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Web Portal Design & Development</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Entrepreneurship & Design Business Management</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Strategic Brand Communication</strong>
                                                </li>

                                                <li><i class="fa-solid fa-circle-check me-2"></i>
                                                    <strong>Professional Project & Showreel Development</strong>
                                                </li>
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more"
                        ...
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <ul class="rbt-list-style-1">
                                ...
                                <li><i class="fa-solid fa-circle-check me-2"></i>Creative Director</li>
                                <li><i class="fa-solid fa-circle-check me-2"></i>UI / UX Designer</li>
                                <li><i class="fa-solid fa-circle-check me-2"></i>Motion Graphics Designer</li>
                                <li><i class="fa-solid fa-circle-check me-2"></i>Digital Media Strategist</li>
                                <li><i class="fa-solid fa-circle-check me-2"></i>Brand & Advertising Executive</li>
                                <li><i class="fa-solid fa-circle-check me-2"></i>Design Consultant / Entrepreneur</li>
                            </ul>


                            <div class="mt-3">
                                <a href="#placement-details" class="btn-animated btn-light">
                                    <div class="btn-text-wrap">
                        ...
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <div class="eligibility-section">
                                ...
                                <ul class="rbt-list-style-1 mt-3">
                                    <li><i class="fa-solid fa-circle-check me-2"></i>Graduation from a recognized university
                                    </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 mb-4 mb-lg-0">
                <h2 class="mb-3 title">
                    WHY STUDY <span>MBA IN GRAPHIC DESIGN </span>
                    at INSD
                </h2>
                ...
                <div class="benifit-wraps">
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Industry-aligned curriculum combining design and business</h5>
                        </div>
                    </div>
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Advanced training in digital design, UI/UX, and multimedia tools</h5>
                        </div>
                    </div>
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Studio-based learning and live project exposure</h5>
                        </div>
                    </div>
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Mentorship from industry professionals</h5>
                        </div>
                    </div>
                    ...
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            <h5>Structured career guidance with placement assistance</h5>
                        </div>
                    </div>
