...
<section class="inner_Section" style="background-image: url('./assets/img/inner_banner/MBA\ in\ Fashion\ Design\ \(1\).jpg');">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="title">
                    MBA in Fashion <br class="d-none d-md-block">
                    <span>Design & Technology</span>
                </h1>

                <p class="para ">

                    A postgraduate program integrating fashion design, <br class="d-none d-md-block">technology, and management to prepare future leaders <br class="d-none d-md-block">of the fashion industry.
                ...
                <div class="course-details-content">
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more" id="overview">
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            <div class="section-title">
                                <h4 class="title-sm">Programs Overview</h4>
                            </div>
                            <p class="para pb-4">
                                The MBA in Fashion Design & Technology at INSD is a career-focused postgraduate program designed for graduates who want to move into leadership, management, and business roles within the fashion industry.
                                The program integrates fashion design, technology-driven processes, and core management disciplines, enabling students to understand the complete fashion ecosystem—from design and production to branding, retail, and strategic decision-making.
                                Learning is practice-driven and industry-aligned, supported by live projects, masterclasses by industry professionals, case studies, internships, and on-the-job training, preparing students for managerial, consultancy, and entrepreneurial careers.
                        ...
                        <div class="rbt-accordion-style rbt-accordion-02 accordion">
                            ...
                            <div class="accordion mt-3" id="curriculumAccordion">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="semOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#semesterOne">
                                ...
                                <!-- Semester 2 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="semTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#semesterTwo">
                                            <i class="fa-solid fa-calendar-days me-2"></i> Semester 2
                                        </button>
                                    </h2>
                                ...
                                <!-- Semester 3 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="semThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#semesterThree">
                                            <i class="fa-solid fa-calendar-days me-2"></i> Semester 3
                                        </button>
                                    </h2>
                                ...
                                <!-- Semester 4 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="semFour">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#semesterFour">
                                            <i class="fa-solid fa-calendar-days me-2"></i> Semester 4
                                        </button>
                                    </h2>
                    ...
                    <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more" id="details">
                        <div class="rbt-course-feature-inner has-show-more-inner-content">
                            ...
                            <p class="para">
                                Graduates of the MBA in Fashion Design & Business are prepared for leadership and
                                managerial roles across design, branding, merchandising, retail, and fashion business operations.
                            </p>
                            ...
                            <ul class="rbt-list-style-1">
                                ...
                                <li><i class="fa-solid fa-circle-check me-2"></i>Opportunities across fashion brands, retail chains, export houses, and corporates</li>
                            </ul>
...
<section class="why-mba-fashion-section py-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                <h2 class="mb-3 title">
                    Why <span>MBA in Fashion Design & <br> Technology</span>
                    at INSD Kolkata
                </h2>
                ...
                <ul class="list-unstyled mt-4">
                    <li class="mb-3 d-flex align-items-start">
                        ...
                        Integrated curriculum combining fashion, technology, and management
                    </li>
                    <li class="mb-3 d-flex align-items-start">
                        <span class="me-2 text-success fs-5">✔</span>
                        Strong focus on execution, strategy, and leadership development
                    </li>
                    <li class="mb-3 d-flex align-items-start">
                        <span class="me-2 text-success fs-5">✔</span>
                        Live projects, industry case studies, and professional exposure
                    </li>
                    <li class="mb-3 d-flex align-items-start">
                        <span class="me-2 text-success fs-5">✔</span>
            ...
            <div class="col-lg-4 text-center">
                <img src="assets/img/f.jpg" alt="MBA Fashion Design & Technology INSD Kolkata" class="img-fluid rounded shadow">
            </div>
...
<section class="career-cta">
    <div class="container text-center">
        ...
        <h3 class="cta-title">
            Advance Your Career in Fashion Design & Technology with INSD
        </h3>
        ...
        <div class="instructor-wrapper shadow-sm p-4 rounded">
            ...
            <div class="instructor-carousel owl-carousel owl-loaded owl-drag">
                ...
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(-1360px, 0px, 0px); transition: 0.7s; width: 4352px;">
