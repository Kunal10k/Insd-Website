...
<section class="about-ban-sec">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2 class="title">About <span>Accreditation</span> </h2>
                <p class="para">
                    Accreditation ensures that our institution follows rigorous academic standards, maintains strong industry relevance, and aligns with globally accepted educational benchmarks. It serves as a formal recognition of our commitment to delivering high-quality education, ethical academic practices, and continuous improvement in teaching and learning processes. Through accreditation, students and stakeholders can be confident that our programs are regularly evaluated, updated, and designed to meet both academic excellence and real-world industry requirements, making it a true mark of trust, credibility, and long-term educational value.
                    <br>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat quos quam ea. Dolore rem, ex facere officia temporibus cum possimus maxime nostrum incidunt obcaecati asperiores? Tempore expedita, sint maiores cumque assumenda at aperiam! Dolores nesciunt culpa est quidem, sunt ab aut minus optio omnis eius debitis, sint delectus quae aliquam?
                </p>
...
<section class="student-test">
    <div class="container">
        ...
        <p class="para text-center ">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deserunt nam quos maxime, quibusdam iure magnam.</p>
        <div class="row g-4 mt-4">
            <div class="col-md-4">
                <div class="course-card">
                    <div class="course-header">
                        <h2 class="pb-0">National Recognition</h2>
                    </div>

                    <p class="ft-sz">Government-aligned curriculum with regular academic audits and quality evaluations.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="course-card">
                    <div class="course-header">
                        <h2 class="pb-0">International Affiliations</h2>
                    </div>
                    <p class="ft-sz">Global academic collaborations and internationally recognized certification standards.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="course-card">
                    <div class="course-header">
                        <h2 class="pb-0">Academic Bodies</h2>
                    </div>

                    <p class="ft-sz">Affiliated with reputed councils ensuring continuous curriculum enhancement.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mt-4">
      <div class="col-md-3">
        <div class="process-card">
          ...
          <p>
            Detailed evaluation of academic structure, learning outcomes, and institutional policies to meet quality standards.
          </p>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="process-card">
          ...
          <h5>Faculty & Infrastructure Review</h5>
          <p>
            Assessment of faculty expertise, teaching practices, campus facilities, and learning resources.
          </p>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="process-card">
          ...
          <h5>Curriculum Validation</h5>
          <p>
            Verification of curriculum relevance, innovation, and alignment with industry and global standards.
          </p>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="process-card">
          ...
          <p>
            Official certification granted after successful review, confirming institutional credibility.
          </p>
        </div>
      </div>
    </div>
